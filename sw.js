...
const ASSETS = [
  ...
  './js/data/services.js','./js/data/zones.js','./js/data/company.js','./js/data/projects.js','./js/data/materials.js',
  ...
  './js/views/materials.js','./js/views/render.js','./js/views/account.js','./js/views/admin.js'
];
