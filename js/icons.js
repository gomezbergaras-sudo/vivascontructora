...
(function (A) {
  ...
  const P = {
    ...
    /* oficios */
    briefcase:'<rect x="2.5" y="7" width="19" height="13" rx="2.2"/><path d="M9 7V5.2A1.7 1.7 0 0 1 10.7 3.5h2.6A1.7 1.7 0 0 1 15 5.2V7"/><path d="M2.5 12.5h19"/><path d="M10.5 12.5v2h3v-2"/>',
    'user-check':'<circle cx="9" cy="8" r="3.8"/><path d="M2.5 20.5c0-3.9 3-6.1 6.5-6.1 1.2 0 2.3.2 3.2.7"/><path d="m15 17 2 2 4-4"/>',
